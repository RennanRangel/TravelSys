document.addEventListener("DOMContentLoaded", () => {
  ...
  for (let i = 0; i < 3; i++) {
    ...
    if (tickers[i].card) {
      ...
      if (tickers[i].country)
        tickers[i].country.textContent = countries[i].name;
      if (tickers[i].capital)
        tickers[i].capital.textContent =
          `${countries[i].capital}, ${countries[i].name}`;
      if (tickers[i].link)
        tickers[i].link.href =
          `/Hotels/Listing?destination=${encodeURIComponent(countries[i].name)}`;
    }
  }
  ...
  function updateTicker() {
    ...
    setTimeout(() => {
      ...
      if (target.link)
        target.link.href = `/Hotels/Listing?destination=${encodeURIComponent(country.name)}`;
  ...
  const featuredStays = [
    {
      ...
      price: "$ 700",
      description:
        "Sri Lanka is a unique experience as it's the best way to unplug from the pushes and pulls of daily life. Explore ancient ruins, lush tea plantations, and pristine beaches in this vibrant island nation.",
      images: [
    ...
    },
    {
      ...
      price: "$ 1,200",
      description:
        "The Maldives is the ultimate tropical paradise. Stay in luxurious overwater bungalows, snorkel in crystal-clear lagoons, and enjoy world-class dining under the stars.",
      images: [
    ...
    },
    {
      ...
      price: "$ 980",
      description:
        "Switzerland offers majestic Alpine scenery and storybook villages. Whether skiing in winter or hiking in summer, the stunning landscapes and cozy chalets make for a perfect getaway.",
      images: [
    ...
    },
    {
      ...
      price: "$ 850",
      description:
        "Experience the perfect blend of ancient tradition and ultra-modern city life in Japan. Stay in a traditional ryokan, soak in hot springs, and enjoy unparalleled hospitality.",
      images: [
    ...
    },
    {
      ...
      price: "$ 750",
      description:
        "Discover the magic of the Greek Islands. Whitewashed buildings, deep blue seas, and spectacular sunsets make Greece an unforgettable destination for a relaxing stay.",
      images: [
  ...
  if (bpDescription)
    bpDescription.style.transition = "opacity 0.4s ease-in-out";
  bpImgs.forEach((img) => {
